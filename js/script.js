...
const elementSearch = document.querySelector('.page__searche')
...
window.addEventListener('scroll' , functionResize)
 ...
 function functionResize(e) {
  ...
  if (Width <= 1280) {
     ...
     functionehead( elementItemMenu.after(elementLogo)  , headerContent.append(elementContact))   
      : 
      functionehead( headerContent.prepend(elementLogo) , elementToheaderColumnsMenus.append(elementContact)   )
